...
class Step_Form extends Step {
	...
	public function __construct(\WBCR\FactoryClearfy234\Pages\Setup $page)
	{
	...
	{
		?>
		<form method="post" id="w-factory-clearfy-234__setup-form-<?php echo $this->get_id() ?>" class="w-factory-clearfy-234__setup-form form-horizontal">
			<?php $form->html(); ?>
			<div class="w-factory-clearfy-234__form-buttons">
				<!--<input type="submit" name="skip_button_<?php /*echo $this->get_id() */ ?>" class="button-primary button button-large w-factory-clearfy-234__skip-button" value="<?php /*_e('Skip', 'wbcr_factory_clearfy_234') */ ?>">-->
				<input type="submit" name="continue_button_<?php echo $this->get_id() ?>" class="button-primary button button-large w-factory-clearfy-234__continue-button" value="<?php _e('Continue', 'wbcr_factory_clearfy_234') ?>">
			</div>
		</form>
		<?php
	}
	...
	public function html()
	{
		...
		<div id="WBCR" class="wrap">
			<div class="wbcr-factory-pages-443-impressive-page-template factory-bootstrap-444 factory-fontawesome-000">
				<div class="w-factory-clearfy-234-setup__inner-wrap">
