 ...
 *
 * @package WBCR\FactoryClearfy234\Pages
...
class Setup extends \Wbcr_FactoryPages443_ImpressiveThemplate {
	...
	public function __construct(\Wbcr_Factory444_Plugin $plugin)
	{
		...
		$this->menu_title = __('Setup master', 'wbcr_factory_clearfy_234');
		$this->page_menu_short_description = __('Setup master', 'wbcr_factory_clearfy_234');
		parent::__construct($plugin);
	}

	public function getPageTitle()
	{
		return __('Setup', 'wbcr_factory_clearfy_234');
	}
	...
	public function assets($scripts, $styles)
	{
		...
		$this->styles->add(FACTORY_CLEARFY_234_URL . '/assets/css/page-setup.css');
	...
	{
		?>
		<div class="w-factory-clearfy-234-setup">
			<ol class="w-factory-clearfy-234-setup-steps">
			...
			<div class="w-factory-clearfy-234-setup-content">
				<?php echo $content; ?>
			</div>
			<a class="w-factory-clearfy-234-setup-footer-links" href="<?php echo esc_url($this->get_close_wizard_url()); ?>">
				<?php _e('Not now', 'wbcr_factory_clearfy_234') ?>
			</a>
		</div>
		<?php
	}
